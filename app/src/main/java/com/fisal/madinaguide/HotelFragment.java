...
public class HotelFragment extends Fragment {
    ...
    public static HotelFragment newInstance(int page, String title) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textURL = (TextView) view.findViewById(R.id.hotel_url);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            textURL.setJustificationMode(Layout.JUSTIFICATION_MODE_INTER_WORD);
        }
